# Alfalah AI Contact Centre — Project Context

> **For new team members:** This file contains the full technical context, decisions, and state of the project.
> It is also used by the AI coding assistant (Antigravity) to instantly recall context across sessions.
